...
- [[#directory-navigation][directory navigation]]
  ...
  - [[#configfishfunctionsffdfish][~/.config/fish/functions/ffd.fish]]
- [[#ffmpeg][ffmpeg]]
  - [[#configfishfunctionsffmpeg-to-giffish][~/.config/fish/functions/ffmpeg-to-gif.fish]]
- [[#ssh][ssh]]
...
#+begin_src fish :tangle "~/.config/fish/conf.d/aliases.fish"
  ...
  alias gl='git log --abbrev-commit --decorate --date=relative --pretty=format:\'%Cred%h%Creset -%C(yellow)%d%Creset %s %Cgreen(%cr) %C(bold blue)<%an>%Creset\''
...
#+begin_src fish :tangle "~/.config/fish/conf.d/fish_user_key_bindings.fish"
  ...
  function fish_user_key_bindings
    ...
    bind -M insert up 'history --merge; up-or-search'
...
** ~/.config/fish/functions/ffd.fish

#+begin_src fish :tangle "~/.config/fish/functions/ffd.fish"
  function ffd --description "find argv[2..] -iname '*argv[1]*'" --argument-names input_str optional_path
    # echo "'*$input_str*'"
...
** ~/.config/fish/functions/ffmpeg-to-gif.fish

#+begin_src fish :tangle "~/.config/fish/functions/ffmpeg-to-gif.fish"
  function ffmpeg-to-gif --argument-names inputfile width fps
    set outputfile $(string split -f 1 . $inputfile).gif

    if not set -q width[1]
      set width 320
    end
    if not set -q fps[1]
      set fps 10
    ...
    # For reference
    # set two_times_speed "setpts=0.5*PTS"
...
#+begin_src fish :tangle "~/.config/fish/functions/authme.fish"
  function authme
      set -l localkeyfile (ls -t ~/.ssh/*.pub | head -n 1)
      ssh $argv 'cat >>.ssh/authorized_keys' <$localkeyfile
  end
#+end_src
