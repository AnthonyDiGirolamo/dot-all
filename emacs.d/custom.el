(custom-set-variables
 ...
 '(package-selected-packages
   '(catppuccin-theme bazel treesit-auto org-superstar org embark embark-consult consult marginalia vertico glsl-mode magit-section transient-posframe transient magit typescript-mode company-lsp flymake jsonrpc counsel-gtags ggtags ibuffer-projectile highlight-indent-guides major-mode-hydra airline-themes hide-mode-line markdown-mode+ markdown-mode yasnippet gif-screencast gn-mode ninja-mode ox-gfm fennel-mode blimp ob-async dts-mode forth-mode jinja2-mode request fill-column-indicator sqlup-mode scad-mode scad-preview steam ssh-config-mode ssh-agency general ht paradox sql-indent pylint moonscript xterm-color fish-mode vimrc-mode company-shell vlf exec-path-from-shell edit-server json-mode yari yaml-mode wgrep-pt subatomic256-theme scss-mode rainbow-delimiters pt pandoc-mode js2-mode htmlize haml-mode go-mode feature-mode esup emmet-mode edbi company-inf-ruby coffee-mode ag))
