...
#+begin_src emacs-lisp
  ...
  (use-package emacs
    ...
    (setq amd/font-size (cond
                         ...
                         (t 18))
          amd/font-name "PragmataPro Mono"
    ...
    (defun amd/set-font (&optional fsize fname antialias)
      ...
      (when (display-graphic-p)
        ...
        (let ((amd/font-spec (font-spec :name amd/font-name :size amd/font-size :antialias amd/font-antialias)))
          (set-frame-font amd/font-spec)
          (add-to-list 'default-frame-alist `(font . ,amd/font-spec)))
    ...
    ;; (set-frame-font (font-spec :name "PragmataPro Mono" :antialias nil :size amd/font-size :weight 'regular))
  ...
  (use-package hydra
    ...
    (defhydra hydra-font (:color red :columns 4)
      ...
      ("s"  (lambda () (interactive)
              (amd/set-font amd/font-size "PragmataPro Mono"))
       (format "[%s] PragmataPro Mono"
               (if (string-equal amd/font-name "PragmataPro Mono") "x" " ")))
