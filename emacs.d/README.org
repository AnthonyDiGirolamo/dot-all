  ...
  #+begin_src emacs-lisp
    ...
    (defun amd/set-font (&optional fsize fname)
      ...
      (when (display-graphic-p)
        ...
        (when fname
          (setq amd/font-name (concat fname "-%d")))
    ...
    (use-package shackle
      ...
      (setq
       ...
       '(;; Hidden popups
         ...
         ('magit-status-mode :popup t :align right)
         ('magit-log-mode :popup t :align right)
  ...
  #+begin_src emacs-lisp
    (use-package hydra
      ...
      (defhydra hydra-font (:color red :columns 3)
        ("h"  (lambda () (interactive) (amd/set-font (- amd/font-size 1.0)))
         (format "smaller %.2f" amd/font-size))
        ("l"  (lambda () (interactive) (amd/set-font (+ amd/font-size 1.0)))
