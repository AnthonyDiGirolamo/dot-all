    ...
    (use-package shackle
      ...
      (setq shackle-default-rule '(:select t)
            ...
            '(
              ...
              ("\\*[Ii]buffer\\*" :regexp t :popup t :align bottom :size 0.4)
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (pretty-hydra-define hydra-set-toggles (:color blue :quit-key "q" :formatter amd/pretty-hydra-strip-header)
       ("Line Endings"
        ...
        "Line Numbers"
        (("ld" display-line-numbers-mode "display-line-numbers-mode" :toggle t :color amaranth)
         ("ln" nlinum-mode "nlinum-mode" :toggle t :color amaranth)
         ("lr" nlinum-relative-mode "nlinum-relative-mode" :toggle t :color amaranth)
