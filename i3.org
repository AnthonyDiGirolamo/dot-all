...
*** PC modifiers
   ...
   #+BEGIN_SRC conf :tangle (if (not (string-match "chip" (shell-command-to-string "uname -a"))) "~/.i3/config" "no") :mkdirp yes
     # i3 config file (v4)
...
*** PocketCHIP modifiers
   ...
   #+BEGIN_SRC conf :tangle (if (string-match "chip" (shell-command-to-string "uname -a")) "~/.i3/config" "no") :mkdirp yes
     set $mod Mod4
